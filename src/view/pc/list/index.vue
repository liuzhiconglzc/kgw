<!--<template>-->
<!--  &lt;!&ndash; <div class="list_back" :class="{'review_back': state == 3}"> &ndash;&gt;-->
<!--  <div class="list_back">-->
<!--    <div class="question">-->
...
<!--import {questionList, likeAdd, likeCancel, collectAdd, collectCancel, questionDetail} from '@/api/question'-->
<!--import index from "@/view/pc/add";-->
...
<!--      // this.$router.push({ name: 'List', query: {state: 3,proId: question.proId } })-->
