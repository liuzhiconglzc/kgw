...
<!--          </van-nav-bar>-->
        ...
        <div style="width: 50%;margin-left: 25%;background: white;position: relative">
          ...
          <div style="margin-top: -10px;color: #42b285; font-size: small; font-weight: bold;position: relative">
            ...
            <div>
              <div style="margin-top: 5px; font-size: small; line-height: 200%; text-align: center; border-radius:2px; background-color: #42b285; color: white;height: 30px; width: 80px;position: relative">问题题目</div>
...
<!--                    </el-option>-->
<!--                  </el-select>-->
                <van-field  style=" height: 28px;transform: translateY(5px);" readonly :value="professionNames" rows="1" autosize type="textarea"
                           placeholder="请选择专业分类（可多选）" @click="topClick" />
              </div>
              <el-image style="position: absolute;width: 14px;margin-left: -10%;transform: translateY(20px);pointer-events:none" :src="require('@/assets/pc/triangle.png')"/>
            </div>
          </div>
          <div style="margin-top: 5px; font-size: small; line-height: 200%; text-align: center; border-radius:2px; background-color: #42b285; color: white;height: 30px; width: 80px;position: relative">问题描述</div>
          ...
          <div style="border:1px solid #ddd;height: 80px;border-radius: 3px;position: relative;color: #b2b2b2">
<!--              <div class="image">-->
              <van-uploader  v-model="imageList" max-count="3" :max-size="1024 * 1024" @oversize="onOversize"
                            :after-read="afterRead" upload-icon="">
                <el-image style="height: 83px;width: 84px;margin-left: -2px;margin-top: -2px" :src="require('@/assets/pc/add.png')">
                </el-image>
            </van-uploader>
            <div style="display: inline-block;margin-left: 15px;transform: translateY(28px);position: absolute">可添加"问题描述"图片(不超过3张)</div>
<!--              </div>-->
<!--              <el-upload-->
<!--                  v-model="imageList"-->
<!--                  class="upload-demo"-->
...
<!--              </el-upload>-->
          ...
          <el-button @click="publishClick" style="margin-top: 5px; margin-left: 220px; font-size: small; line-height: 15%; border-radius:2px; background-color: #42b285; color: white;height: 27px; width: 80px;display: inline-block">
        ...
        <el-dropdown-menu style="margin-left: 335px;margin-top: 105px;width: 250px;height: 330px" v-model="showProfessionPicker" round position="bottom">
          ...
          <div style="margin-top: 20px;display: inline-block">
            <div style="margin-left: 170px;transform: translateY(-7px)" @click="cancelClick">取消</div>
<!--              <div style="display: inline-block;">选择专业</div>-->
            <div style="display: inline-block;margin-left: 40px;transform: translateY(-28px)" @click="doneClick">确认</div>
          </div>
        </el-dropdown-menu>
