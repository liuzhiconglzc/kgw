      ...
      <div class="back">
        ...
        <div style="width: 50%;margin-left: 25%;background: white;position: relative">
          ...
          <div style="color: #42b285; font-size: small; font-weight: bold;position: relative">
            <div style="margin-left: 230px;transform: translateY(45px);position: relative">
              发布问题
            </div>
            <el-image style="width: 10px; height: 10px; margin-top: 32px; margin-left: 288px;position: relative" :src="require('@/assets/pc/pen.png')"/>
            <div>
...
<!--                    </el-option>-->
<!--                  </el-select>-->
                <van-field  style=" height: 30px;transform: translateY(5px);" readonly is-link :value="professionNames" rows="1" autosize type="textarea"
                           placeholder="请选择专业分类（可多选）" @click="topClick" />
              </div>
              <el-image style="position: absolute;width: 14px;margin-left: -30px;transform: translateY(20px);pointer-events:none" :src="require('@/assets/pc/triangle.png')"/>
            </div>
          </div>
          ...
          <div style="margin-top: 5px; font-size: xx-small; background: linear-gradient(to right, #42b285 0%, white 60%);border-left:1px solid #ddd;border-top:1px solid #ddd;border-right:1px solid #ddd; color: white;position: relative">社会现实场景</div>
          <el-input
              type="textarea"
          ...
          <div style="font-size: xx-small; background: linear-gradient(to right, #42b285 0%, white 60%);border-left:1px solid #ddd;border-right:1px solid #ddd; color: white;position: relative">真实问题</div>
          <el-input
              type="textarea"
              placeholder="“真实问题”具体描述(不超过200字)"
              v-model="specific"
              maxlength="100"
              :rows="5"
              resize='none'
...
<!--              <div class="image">-->
              <van-uploader v-model="imageList" max-count="3" :max-size="1024 * 1024" @oversize="onOversize"
                ...
                <el-image style="width: 84px;margin-left: -2px;margin-top: -2px" :src="require('@/assets/pc/add.png')">
                </el-image>
            </van-uploader>
            <div style="display: inline-block;margin-left: 15px;transform: translateY(-35px)">可添加"问题描述"图片(不超过3张)</div>
<!--              </div>-->
<!--              <el-upload-->
<!--                  v-model="imageList"-->
<!--                  class="upload-demo"-->
...
<!--              </el-upload>-->
        ...
        <el-dropdown-menu style="margin-left: 335px;margin-top: 145px;width: 270px;height: 330px" v-model="showProfessionPicker" round position="bottom">
